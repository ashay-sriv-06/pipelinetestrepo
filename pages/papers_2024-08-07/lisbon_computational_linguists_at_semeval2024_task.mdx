...
date: "2024-08-06"
authors: "Artur Guimar, es Bruno, Martins Jo, o Magalh, and es"
---
...
<div className="bg-gray-800 text-white min-h-screen p-8">
  ...
  <p className="text-gray-300 italic mb-6"><strong>Authors:</strong> Artur Guimar, es Bruno, Martins Jo, o Magalh, and es</p>
...
repository</p>
  ...
  <div className="bg-gray-700 p-6 rounded-lg mb-8">
    ...
    <p>The paper describes developing a prompt for a Natural Language Inference task and the subsequent fine-tuning of the model, which indicates a focus on prompt engineering.</p>
  </div>

...
ChatGPT and Claude-instant.</p>
  ...
  <div className="bg-gray-700 p-6 rounded-lg mb-8">
    ...
    <p>The paper introduces a novel approach that prompts language models and also mentions fine-tuning, though it's not obvious if hard prefix prompting or solely the latter is used.</p>
  </div>

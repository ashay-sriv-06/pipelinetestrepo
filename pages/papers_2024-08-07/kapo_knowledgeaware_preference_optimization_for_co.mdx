...
<div className="bg-gray-800 text-white min-h-screen p-8">
  ...
  <p className="text-gray-300 italic mb-6"><strong>Authors:</strong> Ruizhe Zhang, Yongxin Xu, Yuzhen Xiao, Runchuan Zhu, Xinke Jiang, Xu Chu, Junfeng Zhao, Yasha Wang</p>

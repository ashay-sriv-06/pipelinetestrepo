...
Figure 11: Distribution of intermediate layers in all FFNs for Mistral-7B.
  ...
  <p className="text-gray-300 italic mb-6"><strong>Authors:</strong> Yifei Wang, Yuheng Chen, Wanting Wen, Yu Sheng, Linjing Li, Daniel Dajun Zeng</p>
...
Code and data will be available soon.</p>
  ...
  <div className="bg-gray-700 p-6 rounded-lg mb-8">
    ...
    <p>The paper is about Chain-of-Thought (CoT) prompting and how it enhances recall and reasoning performance in Large Language Models, which is relevant to hard prefix prompt engineering.</p>
  </div>
